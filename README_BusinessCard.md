...
BusinessCardApp/
├── Controllers/
│   ├── ViewController.swift         — Main card screen
│   ├── PhoneViewController.swift    — Phone modal
│   ├── EmailViewController.swift    — Email modal
│   └── EditViewController.swift     — Edit screen
```
...
| # | App | Key Concepts |
|---|---|---|
| **1** | **Personal Business Card App** | **Programmatic UI, Auto Layout, UserDefaults, Modals, URL Schemes** |
